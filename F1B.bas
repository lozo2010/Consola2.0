...
File.MakeDir(File.DirRootExternal & "/Consola","F1B")
File.MakeDir(File.DirRootExternal & "/Consola/F1B","configuracion")
...
'spServo.Background=BC
	...
	Label8.Visible=False
	lbNumeroServo.Text="INICIO BUJE"
	lbservotxt.Text="INICIO BUJE"
	servo=lbNumeroServo.Text
	contador_lineas=1
			lista1.Initialize
			listaconfiguracion.Initialize2(Array As String("0","nombre"))
			listaconfiguracion.Set(1,NOMBRE_FICHERO)
				File.WriteList(File.DirRootExternal & "/Consola/F1B/configuracion","Modelo_F1B_"&NOMBRE_FICHERO,listaconfiguracion)
...
ToastMessageShow(numpos,True)
	...
	End If 
		...
		If File.Exists(File.DirRootExternal & "/Consola/F1B","Modelo_F1B_"&NOMBRE_FICHERO)=True Then
	
	
			lbModelo.Text=NOMBRE_FICHERO
			strModelo="Modelo_F1B_"&NOMBRE_FICHERO
	lista1=File.ReadList(File.DirRootExternal & "/Consola/F1B","Modelo_F1B_"&NOMBRE_FICHERO)
	listaconfiguracion=File.ReadList(File.DirRootExternal & "/Consola/F1B/configuracion","Modelo_F1B_"&NOMBRE_FICHERO)
	lvDatos.Clear
	...
	End If
			'For i=0 To 4
				...
				lvDatos.AddSingleLine("INICIO BUJE 1   Giro: "&lista1.Get(0)&"  INICIO")
				  lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("INC.STABILO 2   Giro: "&lista1.Get(1)&"  INICIO")
				  lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("DIRECCION   3   Giro: "&lista1.Get(2)&"  INICIO")
				  lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("C.INCI.ALAS 4   Giro: "&lista1.Get(3)&"  INICIO")
				  lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("FLAPPER     5   Giro: "&lista1.Get(4)&"  INICIO")
				
		'	Next
			
		'	For i=5 To 9 
							    lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("INICIO BUJE 1   Giro: "&lista1.Get(5)&"  RDT")
				  lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("INC.STABILO 2   Giro: "&lista1.Get(6)&"  RDT")
				  lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("DIRECCION   3   Giro: "&lista1.Get(7)&"  RDT")
				  lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("C.INCI.ALAS 4   Giro: "&lista1.Get(8)&"  RDT")
				  lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("FLAPPER     5   Giro: "&lista1.Get(9)&"  RDT")
			'Next
			...
			For i=10 To lista1.Size-1 Step 4
				...
				If servo_aux=1 Then
					servo_aux_nombre="INICIO BUJE 1"
				End If 
				If servo_aux=2 Then
					servo_aux_nombre="INC.STABILO 2"
				End If 
				If servo_aux=3 Then
					servo_aux_nombre="DIRECCION   3"
				End If 
				If servo_aux=4 Then
					servo_aux_nombre="C.INCI.ALAS 4"
				End If 
				If servo_aux=5 Then
				servo_aux_nombre="FLAPPER     5"
				End If 
...
Panel1.Visible=False
	...
	tiempo_minimo=0
		...
		'etGiro.Enabled=True
		tiempo_actual=0
			File.WriteList(File.DirRootExternal & "/Consola/F1B","Modelo_F1B_"&NOMBRE_FICHERO,lista1)
	contador_lineas=1
		End If
...
If servo_actual=1 Then
					servo_actual_nombre="INICIO BUJE 1"
				End If 
				If servo_actual=2 Then
					servo_actual_nombre="INC.STABILO 2"
				End If 
				If servo_actual =3 Then
					servo_actual_nombre="DIRECCION   3"
				End If 
				If servo_actual=4 Then
					servo_actual_nombre="C.INCI.ALAS 4"
				End If 
				If servo_actual=5 Then
				servo_actual_nombre="FLAPPER     5"
				End If 
...
If servo=1 Then
					servo_nombre="INICIO BUJE 1"
				End If 
				If servo=2 Then
					servo_nombre="INC.STABILO 2"
				End If 
				If servo=3 Then
					servo_nombre="DIRECCION   3"
				End If 
				If servo=4 Then
					servo_nombre="C.INCI.ALAS 4"
				End If 
				If servo=5 Then
				servo_nombre="FLAPPER     5"
				End If 
...
dlgFileExpl.Initialize(Activity, "/mnt/sdcard/Consola/F1B", "", True, False, "OK")
...
FilesToDelete.AddAll(File.ListFiles(File.DirRootExternal & "/Consola/F1B"))

For I = 0 To FilesToDelete.Size -1
    
    File.Delete(File.DirRootExternal & "/Consola/F1B", FilesToDelete.Get(I))
...
'	
	If flag_rx=True Then
		...
		If contador=255 Then
			...
			flag_rx=False
			If File.Exists(File.DirRootExternal & "/Consola/F1B","Modelo_F1B_"&nombre_leido) Then
				Dim result As Int
