...
Sub Globals
	...
	Dim flag_inicio_usb As Boolean=False
...
'borrar
'------------------------------------------------
File.MakeDir(File.DirRootExternal,"/Consola/F1A")
File.MakeDir(File.DirRootExternal & "/Consola/F1A","configuracion")
...
spServo.Add("STABILO")
spServo.Add("DIRECCION")
spServo.Add("C.I.ALAS")
spServo.Add("FLAPPER")
spServo.Add("GANCHO/FLAPS 5")
...
'spServo.Background=BC
	...
	contador_lineas=1
			...
			listaconfiguracion.Set(1,NOMBRE_FICHERO)
				File.WriteList(File.DirRootExternal & "/Consola/F1A/configuracion","Modelo_F1A_"&NOMBRE_FICHERO,listaconfiguracion)
...
Panel1.Visible=False
	...
	tiempo_minimo=0
		...
		'etGiro.Enabled=True
		tiempo_actual=0
			File.WriteList(File.DirRootExternal & "/Consola/F1A","Modelo_F1A_"&NOMBRE_FICHERO,lista1)
	contador_lineas=1
		End If
	...
	Catch
		...
		If File.Exists(File.DirRootExternal & "/Consola/F1A","Modelo_F1A_"&NOMBRE_FICHERO)=True Then
			lista1.Clear
			'ToastMessageShow("no existe",False)
			'	NOMBRE_FICHERO=etFichero.Text & " " & config
			lbModelo.Text=NOMBRE_FICHERO
...
servo_lv=str.SubString2(12,13)
		...
		lbNumeroServo.text=servo_lv
			...
			If servo_lv=1 Then
				...
				End If 
				If servo_lv=2 Then
					lbservotxt.Text="DIRECCION"
				End If 
				If servo_lv=3 Then
					lbservotxt.Text="C.I.ALA"
				End If 
				If servo_lv=4 Then
					lbservotxt.Text="FLAPPER"
				End If 
				If servo_lv=5 Then
				lbservotxt.Text="GANCHO/FLAP"
				End If 
...
'Button2.Enabled=False
		End If
	End If
'ANULAMOS LA LINEA 20 (1 LINEA CON DATOS NORMALES) POR PROBLMEA AL MODIFICAR QUE DA MISMO TIEMPO Y MISMO SERVO
'18/4/2015 añadimos otra vez a linea 21
...
'/////////////////////////////////////////////////////////////////////////////////////////////
'/////////////////////////////////////////////////////////////////////////////////////////////
'rEVISAR LOS POS VALOR, SOLO CAMBIO EN LAS PRIMERAS 30 LINEAS
'/////////////////////////////////////////////////////////////////////////////////////////////
'/////////////////////////////////////////////////////////////////////////////////////////////
...
If posicion_mod<30 Then
	If posicion_mod>=20 Then
		pos_mod_aux=posicion_mod.SubString2(1,2)
		pos_valor=(pos_mod_aux*4)+20 'AQUI NO 10 SI NO 20 SI DA FALLO
...
End If
			...
			'SI NO FUNCIONA CAMBIAR SOLO EL VALOR DE 50 90 130 170
			
			borrar_datos(30,40,60)

borrar_datos(40,50,100)

borrar_datos(50,60,140)

borrar_datos(60,70,180)
...
'				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
'
'				lvDatos.AddSingleLine("Servo "&(i-9)&"   Giro: "&lista1.Get(i)&"  REMOLQUE CIRCULAR")
'
'			Next
'			For i=15 To 19
'
'				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
'
'				lvDatos.AddSingleLine("Servo "&(i-14)&"   Giro: "&lista1.Get(i)&"  PRE-START")
'
'			Next
			
			    lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("INC.STABILO 1   Giro: "&lista1.Get(0)&"  REMOLQUE")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("DIRECCION   2   Giro: "&lista1.Get(1)&"  REMOLQUE")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("C.INCI.ALAS 3   Giro: "&lista1.Get(2)&"  REMOLQUE")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("FLAP-FOLDER 4   Giro: "&lista1.Get(3)&"  REMOLQUE")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("GANCHO/FLAP 5   Giro: "&lista1.Get(4)&"  REMOLQUE")
				
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("INC.STABILO 1   Giro: "&lista1.Get(5)&"  RDT")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("DIRECCION   2   Giro: "&lista1.Get(6)&"  RDT")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("C.INCI.ALAS 3   Giro: "&lista1.Get(7)&"  RDT")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("FLAP-FOLDER 4   Giro: "&lista1.Get(8)&"  RDT")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("GANCHO/FLAP 5   Giro: "&lista1.Get(9)&"  RDT")
				
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("INC.STABILO 1   Giro: "&lista1.Get(10)&"  REMOLQUE CIRCULAR")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("DIRECCION   2   Giro: "&lista1.Get(11)&"  REMOLQUE CIRCULAR")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("C.INCI.ALAS 3   Giro: "&lista1.Get(12)&"  REMOLQUE CIRCULAR")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("FLAP-FOLDER 4   Giro: "&lista1.Get(13)&"  REMOLQUE CIRCULAR")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("GANCHO/FLAP 5   Giro: "&lista1.Get(14)&"  REMOLQUE CIRCULAR")
				
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("INC.STABILO 1   Giro: "&lista1.Get(15)&"  PRE-START")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("DIRECCION   2   Giro: "&lista1.Get(16)&"  PRE-START")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("C.INCI.ALAS 3   Giro: "&lista1.Get(17)&"  PRE-START")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
				lvDatos.AddSingleLine("FLAP-FOLDER 4   Giro: "&lista1.Get(18)&"  PRE-START")
				lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
...
Else
		Log("iempo antes de grabar "&tiempo_actual)
	...
	If tiempo_actual>tiempo_minimo Then
		...
		etGiro.Enabled=True
		Log("iempo antes de grabar "&tiempo)
		grabar
...
Log("tiempo antes de comparar ya convertido "&tiempo_actual)
...
num =numerolineas-5
				...
				If servo_actual=1 Then
					servo_actual_nombre="INC.STABILO 1"
				End If 
				If servo_actual=2 Then
					servo_actual_nombre="DIRECCION   2"
				End If 
				If servo_actual=3 Then
					servo_actual_nombre="C.INCI.ALAS 3"
				End If 
				If servo_actual=4 Then
					servo_actual_nombre="FLAPPER     4"
				End If 
				If servo_actual=5 Then
					servo_actual_nombre="GANCHO/FLAP 5"
				End If 



Log("Servo "& servo_actual &"tiempo Actual "&tiempo_actual1&" Numero_lineas "& numerolineas & "numero lineas-5 "&num)
...
End If
    lvDatos.SingleLineLayout.Label.TextColor=Colors.Black
					...
					If servo=1 Then
					servo_nombre="INC.STABILO 1"
				End If 
				If servo=2 Then
					servo_nombre="DIRECCION   2"
				End If 
				If servo=3 Then
					servo_nombre="C.INCI.ALAS 3"
				End If 
				If servo=4 Then
					servo_nombre="FLAPPER     4"
				End If 
				If servo=5 Then
					servo_nombre="GANCHO/FLAP 5"
				End If 
...
Dim aux_valor_giro As String
		...
		End If
			...
			If contador_lineas>=7 Then
						Label9.Text="RDT"
						lbNumeroServo.Enabled=True
							servo=lbNumeroServo.Text
	If contador_lineas-5=1 Then
				lbservotxt.Text="STABILO"
			End If 
			If contador_lineas-5=2 Then
				lbservotxt.Text="TIMON DIREC"
			End If 
			If contador_lineas-5=3 Then
				lbservotxt.Text="C.I.ALA"
			End If 
			If contador_lineas-5=4 Then
				lbservotxt.Text="FLAPPER"
			End If 
			If contador_lineas-5=5 Then
			lbservotxt.Text="GANCHO/FLAP"
			End If
							If giro<=9 Then
								aux_valor_giro="00"&giro
...
'									lbservotxt.Text="TIMON DIREC"bilo
'								End If 
...
If contador_lineas>=13 Then
	If contador_lineas<19 Then
		If contador_lineas>=14 Then
			servo=lbNumeroServo.Text
					If contador_lineas-12=1 Then
				lbservotxt.Text="STABILO"
			End If 
			If contador_lineas-12=2 Then
				lbservotxt.Text="TIMON DIREC"
			End If 
			If contador_lineas-12=3 Then
				lbservotxt.Text="C.I.ALA"
			End If 
			If contador_lineas-12=4 Then
				lbservotxt.Text="FLAPPER"
			End If 
			If contador_lineas-12=5 Then
			lbservotxt.Text="GANCHO/FLAP"
			End If
			If giro<=9 Then
				aux_valor_giro="00"&giro
...
If contador_lineas-20=1 Then
					lbservotxt.Text="STABILO"
				End If 
				If contador_lineas-20=2 Then
					lbservotxt.Text="TIMON DIREC"
				End If 
				If contador_lineas-20=3 Then
					lbservotxt.Text="C.I.ALA"
				End If 
				If contador_lineas-20=4 Then
					lbservotxt.Text="FLAPPER"
				End If 
				If contador_lineas-20=5 Then
				lbservotxt.Text="GANCHO/FLAP"
				End If 
	End If
...
dlgFileExpl.Initialize(Activity, "/mnt/sdcard/Consola/F1A", "", True, False, "OK")
...
FilesToDelete.AddAll(File.ListFiles(File.DirRootExternal & "/Consola/F1A"))

For I = 0 To FilesToDelete.Size -1
    
    File.Delete(File.DirRootExternal & "/Consola/F1A", FilesToDelete.Get(I))
...
'	
	If flag_rx=True Then
		...
		If contador=255 Then
			...
			flag_rx=False
			If File.Exists(File.DirRootExternal & "/Consola/F1A","Modelo_F1A_"&nombre_leido) Then
				Dim result As Int
...
Sub enviar_configuracion
	...
	'	Log(lista.Get(i))
'	For i=lista1.Size-1 To 255
'		lista1.Add(0)
'		
'	Next
'    	lista1.set(223,listaconfiguracion.Get(0))
'	Next
'	
