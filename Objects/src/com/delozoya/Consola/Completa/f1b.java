...
public class f1b extends Activity implements B4AActivity{
	public static f1b mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.delozoya.Consola.Completa", "com.delozoya.Consola.Completa.f1b");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (f1b).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.delozoya.Consola.Completa", "com.delozoya.Consola.Completa.f1b");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.delozoya.Consola.Completa.f1b", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (f1b) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (f1b) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (f1b) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Consola/F1B","Modelo_F1B_"+mostCurrent._nombre_fichero)==anywheresoftware.b4a.keywords.Common.True) { 
...
mostCurrent._lbmodelo.setText((Object)(mostCurrent._nombre_fichero));
 //BA.debugLineNum = 324;BA.debugLine="strModelo=\"Modelo_F1B_\"&NOMBRE_FICHERO";
...
mostCurrent._lista1 = anywheresoftware.b4a.keywords.Common.File.ReadList(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Consola/F1B","Modelo_F1B_"+mostCurrent._nombre_fichero);
 //BA.debugLineNum = 326;BA.debugLine="listaconfiguracion=File.ReadList(File.DirRootExte";
mostCurrent._listaconfiguracion = anywheresoftware.b4a.keywords.Common.File.ReadList(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Consola/F1B/configuracion","Modelo_F1B_"+mostCurrent._nombre_fichero);
...
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 339;BA.debugLine="lvDatos.AddSingleLine(\"INICIO BUJE 1   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INICIO BUJE 1   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (0)))+"  INICIO");
 //BA.debugLineNum = 340;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 341;BA.debugLine="lvDatos.AddSingleLine(\"INC.STABILO 2   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INC.STABILO 2   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (1)))+"  INICIO");
 //BA.debugLineNum = 342;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 343;BA.debugLine="lvDatos.AddSingleLine(\"DIRECCION   3   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("DIRECCION   3   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (2)))+"  INICIO");
 //BA.debugLineNum = 344;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 345;BA.debugLine="lvDatos.AddSingleLine(\"C.INCI.ALAS 4   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("C.INCI.ALAS 4   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (3)))+"  INICIO");
 //BA.debugLineNum = 346;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 347;BA.debugLine="lvDatos.AddSingleLine(\"FLAPPER     5   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("FLAPPER     5   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (4)))+"  INICIO");
 //BA.debugLineNum = 352;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColo";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 353;BA.debugLine="lvDatos.AddSingleLine(\"INICIO BUJE 1   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INICIO BUJE 1   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (5)))+"  RDT");
 //BA.debugLineNum = 354;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 355;BA.debugLine="lvDatos.AddSingleLine(\"INC.STABILO 2   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INC.STABILO 2   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (6)))+"  RDT");
 //BA.debugLineNum = 356;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 357;BA.debugLine="lvDatos.AddSingleLine(\"DIRECCION   3   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("DIRECCION   3   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (7)))+"  RDT");
 //BA.debugLineNum = 358;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 359;BA.debugLine="lvDatos.AddSingleLine(\"C.INCI.ALAS 4   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("C.INCI.ALAS 4   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (8)))+"  RDT");
 //BA.debugLineNum = 360;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 361;BA.debugLine="lvDatos.AddSingleLine(\"FLAPPER     5   Giro: \"";
...
if ((mostCurrent._servo_aux).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 392;BA.debugLine="servo_aux_nombre=\"INICIO BUJE 1\"";
mostCurrent._servo_aux_nombre = "INICIO BUJE 1";
 };
 //BA.debugLineNum = 394;BA.debugLine="If servo_aux=2 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(2))) { 
 //BA.debugLineNum = 395;BA.debugLine="servo_aux_nombre=\"INC.STABILO 2\"";
mostCurrent._servo_aux_nombre = "INC.STABILO 2";
 };
 //BA.debugLineNum = 397;BA.debugLine="If servo_aux=3 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(3))) { 
 //BA.debugLineNum = 398;BA.debugLine="servo_aux_nombre=\"DIRECCION   3\"";
mostCurrent._servo_aux_nombre = "DIRECCION   3";
 };
 //BA.debugLineNum = 400;BA.debugLine="If servo_aux=4 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(4))) { 
 //BA.debugLineNum = 401;BA.debugLine="servo_aux_nombre=\"C.INCI.ALAS 4\"";
mostCurrent._servo_aux_nombre = "C.INCI.ALAS 4";
 };
 //BA.debugLineNum = 403;BA.debugLine="If servo_aux=5 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(5))) { 
 //BA.debugLineNum = 404;BA.debugLine="servo_aux_nombre=\"FLAPPER     5\"";
mostCurrent._servo_aux_nombre = "FLAPPER     5";
 };
...
_tiempo_minimo = (int) (0);
 //BA.debugLineNum = 485;BA.debugLine="lbNumeroServo.Text=\"INICIO BUJE\"";
mostCurrent._lbnumeroservo.setText((Object)("INICIO BUJE"));
 //BA.debugLineNum = 486;BA.debugLine="lbservotxt.Text=\"INICIO BUJE\"";
mostCurrent._lbservotxt.setText((Object)("INICIO BUJE"));
...
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Consola/F1B","Modelo_F1B_"+mostCurrent._nombre_fichero,mostCurrent._lista1);
...
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Consola","F1B");
 //BA.debugLineNum = 164;BA.debugLine="File.MakeDir(File.DirRootExternal & \"/Consola/F1B\"";
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Consola/F1B","configuracion");
...
_initpanel(mostCurrent._panel4,(float) (3),anywheresoftware.b4a.keywords.Common.Colors.White,anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 171;BA.debugLine="label10.Text=\"F1-B\"";
mostCurrent._label10.setText((Object)("F1-B"));
...
mostCurrent._spservo.Add("PULSE AQUI");
 //BA.debugLineNum = 177;BA.debugLine="spServo.Add(\"INICIO BUJE\")";
mostCurrent._spservo.Add("INICIO BUJE");
 //BA.debugLineNum = 178;BA.debugLine="spServo.Add(\"STABILO\")";
mostCurrent._spservo.Add("STABILO");
 //BA.debugLineNum = 179;BA.debugLine="spServo.Add(\"DIRECCION\")";
mostCurrent._spservo.Add("DIRECCION");
 //BA.debugLineNum = 180;BA.debugLine="spServo.Add(\"C.I.ALAS\")";
mostCurrent._spservo.Add("C.I.ALAS");
 //BA.debugLineNum = 181;BA.debugLine="spServo.Add(\"FLAPPER\")";
...
mostCurrent._label8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 217;BA.debugLine="lbNumeroServo.Text=\"INICIO BUJE\"";
mostCurrent._lbnumeroservo.setText((Object)("INICIO BUJE"));
 //BA.debugLineNum = 218;BA.debugLine="lbservotxt.Text=\"INICIO BUJE\"";
mostCurrent._lbservotxt.setText((Object)("INICIO BUJE"));
...
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Consola/F1B/configuracion","Modelo_F1B_"+mostCurrent._nombre_fichero,mostCurrent._listaconfiguracion);
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Consola/F1B","Modelo_F1B_"+mostCurrent._nombre_leido)) { 
...
_flag = (int) (2);
 //BA.debugLineNum = 2596;BA.debugLine="Log(\"flag F1B: \"&flag)";
anywheresoftware.b4a.keywords.Common.Log("flag F1B: "+BA.NumberToString(_flag));
...
if ((mostCurrent._servo).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 2162;BA.debugLine="nom_ser=\"INICIO BUJE\"";
_nom_ser = "INICIO BUJE";
 };
...
mostCurrent._lbnumeroservo.setText((Object)("1"));
 //BA.debugLineNum = 2219;BA.debugLine="lbservotxt.Text=\"INICIO BUJE\"";
mostCurrent._lbservotxt.setText((Object)("INICIO BUJE"));
...
_flag = (int) (1);
 //BA.debugLineNum = 2588;BA.debugLine="Log(\"flag F1B: \"&flag)";
anywheresoftware.b4a.keywords.Common.Log("flag F1B: "+BA.NumberToString(_flag));
...
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 726;BA.debugLine="lvDatos.AddSingleLine(\"INICIO BUJE 1   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INICIO BUJE 1   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (0)))+"  INICIO");
 //BA.debugLineNum = 727;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 728;BA.debugLine="lvDatos.AddSingleLine(\"INC.STABILO 2   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INC.STABILO 2   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (1)))+"  INICIO");
 //BA.debugLineNum = 729;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 730;BA.debugLine="lvDatos.AddSingleLine(\"DIRECCION   3   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("DIRECCION   3   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (2)))+"  INICIO");
 //BA.debugLineNum = 731;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 732;BA.debugLine="lvDatos.AddSingleLine(\"C.INCI.ALAS 4   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("C.INCI.ALAS 4   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (3)))+"  INICIO");
 //BA.debugLineNum = 733;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 734;BA.debugLine="lvDatos.AddSingleLine(\"FLAPPER     5   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("FLAPPER     5   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (4)))+"  INICIO");
 //BA.debugLineNum = 739;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColo";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 740;BA.debugLine="lvDatos.AddSingleLine(\"INICIO BUJE 1   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INICIO BUJE 1   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (5)))+"  RDT");
 //BA.debugLineNum = 741;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 742;BA.debugLine="lvDatos.AddSingleLine(\"INC.STABILO 2   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INC.STABILO 2   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (6)))+"  RDT");
 //BA.debugLineNum = 743;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 744;BA.debugLine="lvDatos.AddSingleLine(\"DIRECCION   3   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("DIRECCION   3   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (7)))+"  RDT");
 //BA.debugLineNum = 745;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 746;BA.debugLine="lvDatos.AddSingleLine(\"C.INCI.ALAS 4   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("C.INCI.ALAS 4   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (8)))+"  RDT");
 //BA.debugLineNum = 747;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 748;BA.debugLine="lvDatos.AddSingleLine(\"FLAPPER     5   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("FLAPPER     5   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (9)))+"  RDT");
...
if ((mostCurrent._servo_aux).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 769;BA.debugLine="servo_aux_nombre=\"INICIO BUJE 1\"";
mostCurrent._servo_aux_nombre = "INICIO BUJE 1";
 };
 //BA.debugLineNum = 771;BA.debugLine="If servo_aux=2 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(2))) { 
 //BA.debugLineNum = 772;BA.debugLine="servo_aux_nombre=\"INC.STABILO 2\"";
mostCurrent._servo_aux_nombre = "INC.STABILO 2";
 };
 //BA.debugLineNum = 774;BA.debugLine="If servo_aux=3 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(3))) { 
 //BA.debugLineNum = 775;BA.debugLine="servo_aux_nombre=\"DIRECCION   3\"";
mostCurrent._servo_aux_nombre = "DIRECCION   3";
 };
 //BA.debugLineNum = 777;BA.debugLine="If servo_aux=4 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(4))) { 
 //BA.debugLineNum = 778;BA.debugLine="servo_aux_nombre=\"C.INCI.ALAS 4\"";
mostCurrent._servo_aux_nombre = "C.INCI.ALAS 4";
 };
 //BA.debugLineNum = 780;BA.debugLine="If servo_aux=5 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(5))) { 
 //BA.debugLineNum = 781;BA.debugLine="servo_aux_nombre=\"FLAPPER     5\"";
mostCurrent._servo_aux_nombre = "FLAPPER     5";
 };
...
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2373;BA.debugLine="lvDatos.AddSingleLine(\"INICIO BUJE 1   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INICIO BUJE 1   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (0)))+"  INICIO");
 //BA.debugLineNum = 2374;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2375;BA.debugLine="lvDatos.AddSingleLine(\"INC.STABILO 2   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INC.STABILO 2   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (1)))+"  INICIO");
 //BA.debugLineNum = 2376;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2377;BA.debugLine="lvDatos.AddSingleLine(\"DIRECCION   3   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("DIRECCION   3   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (2)))+"  INICIO");
 //BA.debugLineNum = 2378;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2379;BA.debugLine="lvDatos.AddSingleLine(\"C.INCI.ALAS 4   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("C.INCI.ALAS 4   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (3)))+"  INICIO");
 //BA.debugLineNum = 2380;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2381;BA.debugLine="lvDatos.AddSingleLine(\"FLAPPER     5   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("FLAPPER     5   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (4)))+"  INICIO");
 //BA.debugLineNum = 2386;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColo";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2387;BA.debugLine="lvDatos.AddSingleLine(\"INICIO BUJE 1   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INICIO BUJE 1   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (5)))+"  RDT");
 //BA.debugLineNum = 2388;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2389;BA.debugLine="lvDatos.AddSingleLine(\"INC.STABILO 2   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INC.STABILO 2   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (6)))+"  RDT");
 //BA.debugLineNum = 2390;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2391;BA.debugLine="lvDatos.AddSingleLine(\"DIRECCION   3   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("DIRECCION   3   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (7)))+"  RDT");
 //BA.debugLineNum = 2392;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2393;BA.debugLine="lvDatos.AddSingleLine(\"C.INCI.ALAS 4   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("C.INCI.ALAS 4   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (8)))+"  RDT");
 //BA.debugLineNum = 2394;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 2395;BA.debugLine="lvDatos.AddSingleLine(\"FLAPPER     5   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("FLAPPER     5   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (9)))+"  RDT");
...
_tiempo_minimo = (int) (0);
 //BA.debugLineNum = 262;BA.debugLine="lbNumeroServo.Text=\"INICIO BUJE\"";
mostCurrent._lbnumeroservo.setText((Object)("INICIO BUJE"));
 //BA.debugLineNum = 263;BA.debugLine="lbservotxt.Text=\"INICIO BUJE\"";
mostCurrent._lbservotxt.setText((Object)("INICIO BUJE"));
...
if ((mostCurrent._servo).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 2107;BA.debugLine="servo_nombre=\"INICIO BUJE 1\"";
_servo_nombre = "INICIO BUJE 1";
 };
 //BA.debugLineNum = 2109;BA.debugLine="If servo=2 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(2))) { 
 //BA.debugLineNum = 2110;BA.debugLine="servo_nombre=\"INC.STABILO 2\"";
_servo_nombre = "INC.STABILO 2";
 };
 //BA.debugLineNum = 2112;BA.debugLine="If servo=3 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(3))) { 
 //BA.debugLineNum = 2113;BA.debugLine="servo_nombre=\"DIRECCION   3\"";
_servo_nombre = "DIRECCION   3";
 };
 //BA.debugLineNum = 2115;BA.debugLine="If servo=4 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(4))) { 
 //BA.debugLineNum = 2116;BA.debugLine="servo_nombre=\"C.INCI.ALAS 4\"";
_servo_nombre = "C.INCI.ALAS 4";
 };
 //BA.debugLineNum = 2118;BA.debugLine="If servo=5 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(5))) { 
 //BA.debugLineNum = 2119;BA.debugLine="servo_nombre=\"FLAPPER     5\"";
_servo_nombre = "FLAPPER     5";
 };
...
mostCurrent._dlgfileexpl._initialize(mostCurrent.activityBA,mostCurrent._activity,"/mnt/sdcard/Consola/F1B","",anywheresoftware.b4a.keywords.Common.True,anywheresoftware.b4a.keywords.Common.False,"OK");
...
_buffer_tx[_i] = (byte) (0);
 ...
 //BA.debugLineNum = 2867;BA.debugLine="buffer_tx(222)=2";
_buffer_tx[(int) (222)] = (byte) (2);
...
if ((mostCurrent._servo_lv).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 945;BA.debugLine="lbservotxt.Text=\"INICIO BUJE\"";
mostCurrent._lbservotxt.setText((Object)("INICIO BUJE"));
 };
 //BA.debugLineNum = 947;BA.debugLine="If servo_lv=2 Then";
if ((mostCurrent._servo_lv).equals(BA.NumberToString(2))) { 
 //BA.debugLineNum = 948;BA.debugLine="lbservotxt.Text=\"STABILO\"";
mostCurrent._lbservotxt.setText((Object)("STABILO"));
 };
 //BA.debugLineNum = 950;BA.debugLine="If servo_lv=3 Then";
if ((mostCurrent._servo_lv).equals(BA.NumberToString(3))) { 
 //BA.debugLineNum = 951;BA.debugLine="lbservotxt.Text=\"DIRECCION\"";
mostCurrent._lbservotxt.setText((Object)("DIRECCION"));
 };
 //BA.debugLineNum = 953;BA.debugLine="If servo_lv=4 Then";
if ((mostCurrent._servo_lv).equals(BA.NumberToString(4))) { 
 //BA.debugLineNum = 954;BA.debugLine="lbservotxt.Text=\"C.I.ALA\"";
mostCurrent._lbservotxt.setText((Object)("C.I.ALA"));
 };
 //BA.debugLineNum = 956;BA.debugLine="If servo_lv=5 Then";
if ((mostCurrent._servo_lv).equals(BA.NumberToString(5))) { 
 //BA.debugLineNum = 957;BA.debugLine="lbservotxt.Text=\"FLAPPER\"";
mostCurrent._lbservotxt.setText((Object)("FLAPPER"));
 };
...
if ((mostCurrent._servo).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 1051;BA.debugLine="lbservotxt.Text=\"INICIO BUJE\"";
mostCurrent._lbservotxt.setText((Object)("INICIO BUJE"));
 };
 //BA.debugLineNum = 1053;BA.debugLine="If servo=2 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(2))) { 
 //BA.debugLineNum = 1054;BA.debugLine="lbservotxt.Text=\"STABILO\"";
mostCurrent._lbservotxt.setText((Object)("STABILO"));
 };
 //BA.debugLineNum = 1056;BA.debugLine="If servo=3 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(3))) { 
 //BA.debugLineNum = 1057;BA.debugLine="lbservotxt.Text=\"DIRECCION\"";
mostCurrent._lbservotxt.setText((Object)("DIRECCION"));
 };
 //BA.debugLineNum = 1059;BA.debugLine="If servo=4 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(4))) { 
 //BA.debugLineNum = 1060;BA.debugLine="lbservotxt.Text=\"C.I.ALA\"";
mostCurrent._lbservotxt.setText((Object)("C.I.ALA"));
 };
 //BA.debugLineNum = 1062;BA.debugLine="If servo=5 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(5))) { 
 //BA.debugLineNum = 1063;BA.debugLine="lbservotxt.Text=\"FLAPPER\"";
mostCurrent._lbservotxt.setText((Object)("FLAPPER"));
 };
...
if (_servo_actual==1) { 
 //BA.debugLineNum = 1852;BA.debugLine="servo_actual_nombre=\"INICIO BUJE 1\"";
_servo_actual_nombre = "INICIO BUJE 1";
 };
 //BA.debugLineNum = 1854;BA.debugLine="If servo_actual=2 Then";
if (_servo_actual==2) { 
 //BA.debugLineNum = 1855;BA.debugLine="servo_actual_nombre=\"INC.STABILO 2\"";
_servo_actual_nombre = "INC.STABILO 2";
 };
 //BA.debugLineNum = 1857;BA.debugLine="If servo_actual =3 Then";
if (_servo_actual==3) { 
 //BA.debugLineNum = 1858;BA.debugLine="servo_actual_nombre=\"DIRECCION   3\"";
_servo_actual_nombre = "DIRECCION   3";
 };
 //BA.debugLineNum = 1860;BA.debugLine="If servo_actual=4 Then";
if (_servo_actual==4) { 
 //BA.debugLineNum = 1861;BA.debugLine="servo_actual_nombre=\"C.INCI.ALAS 4\"";
_servo_actual_nombre = "C.INCI.ALAS 4";
 };
 //BA.debugLineNum = 1863;BA.debugLine="If servo_actual=5 Then";
if (_servo_actual==5) { 
 //BA.debugLineNum = 1864;BA.debugLine="servo_actual_nombre=\"FLAPPER     5\"";
_servo_actual_nombre = "FLAPPER     5";
 };
...
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1743;BA.debugLine="lvDatos.AddSingleLine(\"INICIO BUJE 1   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INICIO BUJE 1   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (0)))+"  INICIO");
 //BA.debugLineNum = 1744;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1745;BA.debugLine="lvDatos.AddSingleLine(\"INC.STABILO 2   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INC.STABILO 2   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (1)))+"  INICIO");
 //BA.debugLineNum = 1746;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1747;BA.debugLine="lvDatos.AddSingleLine(\"DIRECCION   3   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("DIRECCION   3   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (2)))+"  INICIO");
 //BA.debugLineNum = 1748;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1749;BA.debugLine="lvDatos.AddSingleLine(\"C.INCI.ALAS 4   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("C.INCI.ALAS 4   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (3)))+"  INICIO");
 //BA.debugLineNum = 1750;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1751;BA.debugLine="lvDatos.AddSingleLine(\"FLAPPER     5   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("FLAPPER     5   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (4)))+"  INICIO");
 //BA.debugLineNum = 1756;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColo";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1757;BA.debugLine="lvDatos.AddSingleLine(\"INICIO BUJE 1   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INICIO BUJE 1   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (5)))+"  RDT");
 //BA.debugLineNum = 1758;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1759;BA.debugLine="lvDatos.AddSingleLine(\"INC.STABILO 2   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("INC.STABILO 2   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (6)))+"  RDT");
 //BA.debugLineNum = 1760;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1761;BA.debugLine="lvDatos.AddSingleLine(\"DIRECCION   3   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("DIRECCION   3   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (7)))+"  RDT");
 //BA.debugLineNum = 1762;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1763;BA.debugLine="lvDatos.AddSingleLine(\"C.INCI.ALAS 4   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("C.INCI.ALAS 4   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (8)))+"  RDT");
 //BA.debugLineNum = 1764;BA.debugLine="lvDatos.SingleLineLayout.Label.TextColor=Col";
mostCurrent._lvdatos.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 1765;BA.debugLine="lvDatos.AddSingleLine(\"FLAPPER     5   Giro: \"";
mostCurrent._lvdatos.AddSingleLine("FLAPPER     5   Giro: "+BA.ObjectToString(mostCurrent._lista1.Get((int) (9)))+"  RDT");
...
if ((mostCurrent._servo_aux).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 1773;BA.debugLine="servo_aux_nombre=\"INICIO BUJE 1\"";
mostCurrent._servo_aux_nombre = "INICIO BUJE 1";
 };
 //BA.debugLineNum = 1775;BA.debugLine="If servo_aux=2 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(2))) { 
 //BA.debugLineNum = 1776;BA.debugLine="servo_aux_nombre=\"INC.STABILO 2\"";
mostCurrent._servo_aux_nombre = "INC.STABILO 2";
 };
 //BA.debugLineNum = 1778;BA.debugLine="If servo_aux=3 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(3))) { 
 //BA.debugLineNum = 1779;BA.debugLine="servo_aux_nombre=\"DIRECCION   3\"";
mostCurrent._servo_aux_nombre = "DIRECCION   3";
 };
 //BA.debugLineNum = 1781;BA.debugLine="If servo_aux=4 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(4))) { 
 //BA.debugLineNum = 1782;BA.debugLine="servo_aux_nombre=\"C.INCI.ALAS 4\"";
mostCurrent._servo_aux_nombre = "C.INCI.ALAS 4";
 };
 //BA.debugLineNum = 1784;BA.debugLine="If servo_aux=5 Then";
if ((mostCurrent._servo_aux).equals(BA.NumberToString(5))) { 
 //BA.debugLineNum = 1785;BA.debugLine="servo_aux_nombre=\"FLAPPER     5\"";
mostCurrent._servo_aux_nombre = "FLAPPER     5";
 };
...
mostCurrent._lbmodelo.setText((Object)(mostCurrent._nombre_fichero));
 //BA.debugLineNum = 581;BA.debugLine="strModelo=\"Modelo_F1B_\"&NOMBRE_FICHERO";
_strmodelo = "Modelo_F1B_"+mostCurrent._nombre_fichero;
...
_tiempo_minimo = (int) (0);
 //BA.debugLineNum = 598;BA.debugLine="lbNumeroServo.Text=\"INICIO BUJE\"";
mostCurrent._lbnumeroservo.setText((Object)("INICIO BUJE"));
 //BA.debugLineNum = 599;BA.debugLine="lbservotxt.Text=\"INICIO BUJE\"";
mostCurrent._lbservotxt.setText((Object)("INICIO BUJE"));
...
mostCurrent._lbmodelo.setText((Object)(mostCurrent._nombre_fichero));
 //BA.debugLineNum = 623;BA.debugLine="strModelo=\"Modelo_F1B_\"&NOMBRE_FICHERO";
_strmodelo = "Modelo_F1B_"+mostCurrent._nombre_fichero;
...
_tiempo_minimo = (int) (0);
 //BA.debugLineNum = 640;BA.debugLine="lbNumeroServo.Text=\"INICIO BUJE\"";
mostCurrent._lbnumeroservo.setText((Object)("INICIO BUJE"));
 //BA.debugLineNum = 641;BA.debugLine="lbservotxt.Text=\"INICIO BUJE\"";
mostCurrent._lbservotxt.setText((Object)("INICIO BUJE"));
...
if ((mostCurrent._servo).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 540;BA.debugLine="nom_ser=\"INICIO BUJE\"";
_nom_ser = "INICIO BUJE";
 };
 //BA.debugLineNum = 542;BA.debugLine="If servo=2 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(2))) { 
 //BA.debugLineNum = 543;BA.debugLine="nom_ser=\"STABILO\"";
_nom_ser = "STABILO";
 };
 //BA.debugLineNum = 545;BA.debugLine="If servo=3 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(3))) { 
 //BA.debugLineNum = 546;BA.debugLine="nom_ser=\"TIMON DIREC\"";
_nom_ser = "TIMON DIREC";
 };
 //BA.debugLineNum = 548;BA.debugLine="If servo=4 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(4))) { 
 //BA.debugLineNum = 549;BA.debugLine="nom_ser=\"C.I.ALA\"";
_nom_ser = "C.I.ALA";
 };
 //BA.debugLineNum = 551;BA.debugLine="If servo=5 Then";
if ((mostCurrent._servo).equals(BA.NumberToString(5))) { 
 //BA.debugLineNum = 552;BA.debugLine="nom_ser=\"FLAPPER\"";
_nom_ser = "FLAPPER";
 };
