...
public class clschecklist extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.delozoya.Consola.Completa.clschecklist");
            if (htSubs == null) {
...
int _i = 0;
com.delozoya.Consola.Completa.clschecklist._typsortdata _sortdata = null;
int _firsttosort = 0;
int _lasttosort = 0;
...
_sortdata = (com.delozoya.Consola.Completa.clschecklist._typsortdata)(_sortlist.Get((int) (_i-_firstposition)));
